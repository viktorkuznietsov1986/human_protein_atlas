...
def train_model(model, train_generator, validation_generator, batch_size, train_size, dev_size, epochs=3):
    ...
    model.fit_generator(train_generator, steps_per_epoch=train_size//batch_size, validation_data=validation_generator, validation_steps=dev_size//batch_size, epochs=epochs, callbacks=[checkpoint_callback], )
